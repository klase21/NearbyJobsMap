...
export function canonicalJob(overrides: Partial<CanonicalJob> = {}): CanonicalJob {
  return {
    ...
    nearestStation: null, latitude: null, longitude: null, locationAccuracy: "exact_address",
    workplaces: [{ originalText: "서울 강남구 테헤란로 1", roadAddress: "서울 강남구 테헤란로 1", parcelAddress: null, city: "서울", district: "강남구", neighborhood: "역삼동", nearestStation: null, latitude: null, longitude: null, accuracy: "exact_address", isHeadquartersOnly: false }], workplaceCount: 1,
