  ...
  return <div className="collection-overview">
    ...
    {dashboard && <>
      ...
      <DashboardSection title="데이터 품질" description="통근 준비는 신뢰 가능한 좌표 또는 전체 주소가 있는 공고만 보수적으로 집계합니다. 경로·통근비 계산은 아직 제공하지 않습니다."><MetricGrid items={[
        ...
        ["구조화 급여", dashboard.dataQuality.salary.structured], ["표시 급여만", dashboard.dataQuality.salary.display_only], ["급여 협의", dashboard.dataQuality.salary.negotiable], ["급여 미확인", dashboard.dataQuality.salary.unknown], ["잘못된 급여", dashboard.dataQuality.salary.invalid], ["좌표 있음", dashboard.dataQuality.coordinateRecords], ["통근 준비", dashboard.dataQuality.commuteReadyRecords]
      ]} /></DashboardSection>
